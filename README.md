...
Tell Repo where to find the manifest:
    ...
    $ repo init -u git://github.com/RedFIR/yocto-gumstix-manifest.git 
...
To test out the bleeding edge, type:
    ...
    $ repo init -u git://github.com/RedFIR/yocto-gumstix-manifest.git -b dev
    $ repo sync

To get back to the known stable version, type:

    $ repo init -u git://github.com/RedFIR/yocto-gumstix-manifest.git -b master
    $ repo sync
...
For example,
    ...
    $ repo init -u git://github.com/RedFIR/yocto-gumstix-manifest.git -b refs/tags/dizzy
